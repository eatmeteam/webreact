          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav mr-auto">
                ...
                <li className="nav-item dropdown active">
                    ...
                    <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                    <Link className="dropdown-item" to='/predev1'>29 APRIL 2020</Link>
                    <div className="dropdown-divider"></div>
                    <Link className="dropdown-item" to='/predev2'>2 MAY 2020</Link>
                    <div className="dropdown-divider"></div>
                    <Link className="dropdown-item" to='/predev3'>4 MAY 2020</Link>
                    <div className="dropdown-divider"></div>
                    <Link className="dropdown-item" to='/predev4'>9 MAY 2020</Link>
                    <div className="dropdown-divider"></div>
                    <Link className="dropdown-item" to='/160520'>16 MAY 2020</Link>
                    <div className="dropdown-divider"></div>
                    <Link className="dropdown-item" to='/230520'>23 MAY 2020</Link>
                    </div>
                </li>
                {/* <!-- End Workshop --> */}
              </ul>
